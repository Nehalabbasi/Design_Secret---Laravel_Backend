...
.ct_remember_leb label.form-check-label {
    width: 108px;
}

.ct_remember_leb input#remember {
    margin: 0;
    width: auto;
}
          ...
          <div class="col-lg-12">
			...
			<div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="ct_login_main">
                            <div>
                                <div class="form-check">
									<div class="ct_remember_leb">
										<input class="form-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}>
										<label class="form-check-label" for="remember">
											{{ __('Remember Me') }}
										</label>
									</div>
									<button class="sign_in_btn" type="submit" class="btn btn-primary">
										{{ __('Login') }}
											</button>
                                </div>
                            </div>
