  ...
  <body>
    ...
    <section class="banner_img">
      <div class="innerban-img">
        <img src='assets//images/service_bg.jpg' alt='image' class='img-fluid'>
      ...
      <section class="about-sec" id="sectiononee">
        ...
        <div class="container">
          <div class="about_side_img">
            <img src="assets/images/about-img-side.png" alt="">
          </div>
        ...
        <img src="assets/images/about-bg.png" alt="" class="about-bg" />
      </section>
      <!-- about section end -->
        ...
        <div class="container">
          <div class="row gx-5">
            <div class="col-lg-6  wow bounceInLeft" data-wow-delay="1s">
              <div class="get_img">
                <img src="assets/images/get_touch_img.png" class="img-fluid" alt="">
              </div>
            </div>
